"""
Django settings for http_token_learn_backend project.
...
ROOT_URLCONF = "http_token_learn_backend.urls"
...
WSGI_APPLICATION = "http_token_learn_backend.wsgi.application"
...
SIMPLE_JWT = {
    ...
    # header still exists internally
